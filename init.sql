CREATE TABLE IF NOT EXISTS student (id serial PRIMARY KEY, email varchar(1000),pwd varchar(65535),username varchar(1000), learnstyle varchar(1000));

CREATE TABLE IF NOT EXISTS client (id serial PRIMARY KEY, email varchar(1000),pwd varchar(65535),clientname varchar(1000));
...
CREATE TABLE IF NOT EXISTS course (id serial PRIMARY KEY, coursename varchar(1000),coursedescription varchar(65535),CONSTRAINT clientid FOREIGN KEY (id) REFERENCES client(id) ON DELETE CASCADE);
